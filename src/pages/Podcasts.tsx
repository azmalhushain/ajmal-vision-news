...
import { Play, Pause, Clock, Pin, Heart, MessageCircle, ChevronDown, ChevronUp, Loader2 } from "lucide-react";
            ...
            <>
              ...
              <div ref={loadMoreRef} className="flex justify-center py-8">
                ...
                {!hasMore && podcasts.length > 0 && (
                  <p className="text-muted-foreground">No more podcasts to load</p>
                )}
              </div>
            </>
          )}
